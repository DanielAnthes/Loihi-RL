...
STEPS = 240  # each trial is max 30 seconds
...
with nengo.Network() as model:
    ...
    nengo.Connection(envstate[:2], agent.net.input, synapse=0)
    ...
    actorprobe = nengo.Probe(agent.Actor.net.output)
...
util.plot_actor_turn(sim, actorprobe, envprobe)
plt.show()
